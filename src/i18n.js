      ...
      ar: {
        translation: {
          ...
          about: {
            ...
            summary: `انا مبرمج واجهات امامية و نظم خلفية لتطبيقات الانترنت. اعمل كعامل مستقل، و اقيم في تركيا.`,
            workWithMe: `اعمل معي`,
          ...
          contact: {
            header: `اعمل معي`,
            paragraph: `مهتم بالعمل معي، لنحصل على محادثة، سأشتري انا فنجان القهوة `,
            label: {
              name: 'الإسم',
